...
{
	uint8_t module=1;//module=1:原有配置，module=0:故障指示器配置
  ...
  {
  // 9.6K bps setting
	SpiWriteRegister(0x1c, 0x1e);	//空中速率设为9.6K
	SpiWriteRegister(0x20, 0xd0); 	 
	SpiWriteRegister(0x21, 0x00); 
	SpiWriteRegister(0x22, 0x9d); 
	SpiWriteRegister(0x23, 0x49); 
	SpiWriteRegister(0x24, 0x00); 
	SpiWriteRegister(0x25, 0x24);	
	SpiWriteRegister(0x2a, 0x14);
  ...
  {
  SpiWriteRegister(0x75, 0x57);  	// 频率:  470 MHz
	SpiWriteRegister(0x76, 0x00);  
...
void Si4432::set_config()
{
    ...
    SpiWriteRegister(0x75, 0x57); /*????,280M~290M*/
    SpiWriteRegister(0x76, 0x00); /*??????,fc[15:8]*/
    SpiWriteRegister(0x77, 0x00); /*??????,fc[7:0]*/
    
    SpiWriteRegister(0x79, 0x00); /*??????,fhch[7:0]*/
    SpiWriteRegister(0x7A, 0x00); /*????,fhs[7:0]*/
    
    SpiWriteRegister(0x6E, 0x4E); /*TX??????1,txdr[15:8]*/
    SpiWriteRegister(0x6F, 0xA5); /*TX??????0,txdr[7:0]*/
    
    SpiWriteRegister(0x70, 0x2C); /*??????1*/
    SpiWriteRegister(0x6D, 0x05); /*????,+20dBM~-1dBM,txpow[2:0],??;3dBM*/
    
    SpiWriteRegister(0x72, 0x30); /*????*/
    SpiWriteRegister(0x1C, 0x1E); /*???????*/
    SpiWriteRegister(0x20, 0xD0); /*????????*/
    SpiWriteRegister(0x21, 0x00); /*??????2*/
    SpiWriteRegister(0x22, 0x9D); /*??????1*/
    SpiWriteRegister(0x23, 0x49); /*??????0*/
    SpiWriteRegister(0x24, 0x00); /*??????????1*/
    SpiWriteRegister(0x25, 0x24); /*??????????0*/
    SpiWriteRegister(0x1D, 0x40); /*AFC??????*/
    SpiWriteRegister(0x1E, 0x0A); /*AFC???????*/
    SpiWriteRegister(0x2A, 0x20); /*AFC???*/
    
    SpiWriteRegister(0x35, 0x2A); /*????????1*/
    SpiWriteRegister(0x34, 0xC8); /*?????,??:4bytes*/
    SpiWriteRegister(0x33, 0x02); /*????2*/
		
    SpiWriteRegister(0x36, 0x20); /*???3*/
    SpiWriteRegister(0x37, 0xD4); /*???2*/
		
		SpiWriteRegister(0x38, 0x20); /*???1*/
    SpiWriteRegister(0x39, 0xD4); /*???0*/
		
    SpiWriteRegister(0x30, 0x89); /*??????*/
    SpiWriteRegister(0x32, 0x00); /*????1*/
    SpiWriteRegister(0x71, 0x63); /*???????2*/
        
    SpiWriteRegister(0x7D, 10); /*TX??????*/
    SpiWriteRegister(0x7E, 50); /*RX??????*/
    
    //??
    //SpiWriteRegister(0x0B, 0x15);//write 0x15 to the GPIO0 Configuration(set the RX state)     
    //SpiWriteRegister(0x0C, 0x12);//write 0x12 to the GPIO1 Configuration(set the TX state)
    
    //??
    SpiWriteRegister(0x0B, 0x12);//write 0x12 to the GPIO0 Configuration(set the RX state)     
    SpiWriteRegister(0x0C, 0x15);//write 0x15 to the GPIO1 Configuration(set the TX state)
   
    SpiWriteRegister(0x09, 0xD7); /*30MHz??????????*/
    
    SpiWriteRegister(0x60, 0xF0);
    SpiWriteRegister(0x14, 0x00); /*WUP?R?,???20(???)*/
    SpiWriteRegister(0x15, 0x20); /*WUP?M?*/
    SpiWriteRegister(0x16, 0x01); /*WUP?M?*/
    SpiWriteRegister(0x19, 0x28); /*LDC??*/
    SpiWriteRegister(0x07, 0x20); /*????????????1*/
    SpiWriteRegister(0x08, 0x04); /*????????????2*/
    SpiWriteRegister(0x05, 0x12); /*???????1*/
    SpiWriteRegister(0x06, 0x00); /*???????2*/
}
#endif
//------------------------------------------------------------------------------------------------
// 函数名: set_rx_mode
